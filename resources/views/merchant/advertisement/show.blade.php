                    ...
                    <div class="col-md-12">
                        ...
                        <section class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    {{__('ADV Data')}}
                                    <span style="float: right;"><a class="btn btn-outline-primary"  href="javascript:void();" onclick="urlIframe('{{route('panel.merchant.advertisement.edit',$result->id)}}')"><i class="fa fa-pencil"></i> {{__('Edit')}}</a></span>
                                </h4>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('panel.merchant.merchant.show',$result->merchant->id)}}">{{$result->merchant->{'name_'.$systemLang} }}</a>
                                                </td>
                                            </tr>
                                            @endif
