    ...
    <div class="content-body">
        ...
        <section id="server-processing">
            <div class="row">
                    ...
                    @endif
                    {!! Form::open(['route' => isset($result->id) ? ['panel.merchant.advertisement.update',$result->id]:'panel.merchant.advertisement.store','method' => isset($result->id) ?  'PATCH' : 'POST','files' => true]) !!}
                    <div class="col-sm-12">
                        <div class="card">
