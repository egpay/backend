...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>EGPAY - Merchant Login</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                    ...
                    <form autocomplete="off" class="form-horizontal form-simple" method="post" action="{{ url('merchant/login') }}" novalidate>
                    {{ csrf_field() }}
                        <fieldset  class="form-group{{ $errors->has('id') ? ' has-danger' : '' }} position-relative has-icon-left mb-0" style="margin-bottom: 7px !important;">
                           <div class="controls">

                            <input value="{{old('id')}}" autocomplete="off" type="text" class="form-control form-control-lg input-lg" id="user-name" placeholder="{{__('Enter Your ID')}}" data-validation-required-message="This field is required" name="id" required>
