...
@section('content')
            ...
            <div class="content-body">
                ...
                <section id="server-processing">
                        {!! Form::open(['route' => isset($result->id) ? ['panel.merchant.branch.update',$result->id]:'panel.merchant.branch.store','files'=>true, 'method' => isset($result->id) ?  'PATCH' : 'POST']) !!}
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-header">
                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'address_en',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('address_en', __('Address').':') !!}
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'description_en',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('description_en', __('Description').':') !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'address_ar',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('address_ar', __('Address').':') !!}
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'description_ar',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('description_ar', __('Description').':') !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block card-dashboard">
                                        <div class="form-group col-sm-12{!! formError($errors,'area_id',true) !!}">
                                            ...
                                            @endphp
                                            {!! Form::select('area_id[]',array_merge([0=>__('Select Area')],$arrayOfArea),((isset($result->id))?$result->area_id:null),['class'=>'form-control','id'=>'area_id','onchange'=>'getNextAreas($(this).val(),"'.$areaData['type']->id.'",\'#nextAreasID\')']) !!}
