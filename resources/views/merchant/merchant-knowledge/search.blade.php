                ...
                <section id="search-website" class="card overflow-hidden">
                    ...
                    <div class="card-body collapse in">
                        <div class="card-block pb-0" style="padding-bottom: 0px !important;">
                            {!! Form::open(['id'=>'s_form','route' => 'panel.merchant.merchant-knowledge.search','method'=>'GET','style'=>'margin-bottom: 0px !important;']) !!}
                                ...
                                <ul class="media-list row">
                                    ...
                                    <li class="media">
                                        <div class="media-body">
                                            <p class="lead mb-0"><a href="javascript:void();" onclick="urlIframe('{{route('panel.merchant.merchant-knowledge.show',$value['id'])}}')">{{$value['name_'.$systemLang]}}</a></p>
