                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        @endphp
                                        {!! Form::select('area_id[]',array_merge([0=>__('Select Area')],$arrayOfArea),null,['class'=>'form-control input-sm','id'=>'area_id','onchange'=>'getNextAreas($(this).val(),"'.$areaData['type']->id.'",\'#nextAreasID\')']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('status',[__('Select Status'),'active'=>__('Active'),'in-active'=>__('In-Active')],null,['class'=>'form-control input-sm']) !!}
                                    </fieldset>
                                </div>
