                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('creatable_type',__('User Type')) }}
                                    {!! Form::select('creatable_type',[''=>__('Select User Type'),'App\Models\Staff'=>__('Staff'),'App\Models\User'=>__('Users'),'App\Models\MerchantStaff'=>__('Merchant Staff')],null,['class'=>'form-control','id'=>'service_type']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('creatable_id',__('User ID')) }}
                                    {!! Form::number('creatable_id',null,['class'=>'form-control','id'=>'creatable_id']) !!}
                                </fieldset>
                            </div>
        ...
        $dataTableVar = $('#egpay-datatable').DataTable({
            ...
            "fnPreDrawCallback": function(oSettings) {
                for (var i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
                    ...
                    $('#SYSTEM_TOTAL').html('<b>'+oSettings.aoData[i]._aData[10]+'</b>');
                    $('#SYSTEM_TOTAL_AMOUNT').html('<b>'+oSettings.aoData[i]._aData[11]+'</b>');
