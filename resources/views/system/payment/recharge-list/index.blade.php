                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('status',[''=>__('Select  Status'),'request'=>__('Request'),'approved'=>__('Approved'),'pending'=>__('Pending'),'done'=>__('Done'),'fail'=>__('Fail'),'cancel'=>__('Cancel')],null,['class'=>'form-control','id'=>'status']) !!}
                                </fieldset>
                            </div>
