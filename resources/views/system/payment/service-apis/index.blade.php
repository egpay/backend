                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::number('external_system_id',null,['class'=>'form-control','id'=>'external_system_id']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('payment_sdk_id',[''=>'Select Payment SDK']+array_column($paymentSDK->toArray(),'name','id'),null,['class'=>'form-control','id'=>'payment_sdk_id']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('payment_service_id',[''=>'Payment Service']+array_column($paymentServices->toArray(),'name','id'),null,['class'=>'form-control','id'=>'payment_service_id']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('service_type',[''=>__('Select Service Type'),'payment'=>__('Payment'),'inquiry'=>__('Inquiry'),'inquire'=>__('Inquire')],null,['class'=>'form-control','id'=>'service_type']) !!}
                                </fieldset>
                            </div>
        ...
        $dataTableVar = $('#egpay-datatable').DataTable({
            ...
            "fnPreDrawCallback": function(oSettings) {
                for (var i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
                    if(oSettings.aoData[i]._aData[{{$tableStatus}}] != ''){
                        oSettings.aoData[i].nTr.className = oSettings.aoData[i]._aData[{{$tableStatus}}];
                    }
                }
            }
            @endif
