                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('type',[''=>__('Select Type'),'sms'=>__('SMS'),'email'=>__('Email')],null,['class'=>'form-control','id'=>'type']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::text('send_to',null,['class'=>'form-control','id'=>'send_to']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('status',[__('Select Status'),'request'=>__('Request'),'success'=>__('Success'),'failed'=>__('Failed')],null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
