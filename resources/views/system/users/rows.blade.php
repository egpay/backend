                            ...
                            <div class="card">
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block card-dashboard">
                                        <p class="card-text">
                                            Server-side processing is enabled by setting the <code>serverSide option</code> to true and providing an <code>Ajax</code> data source through the ajax option.
                                        </p>
