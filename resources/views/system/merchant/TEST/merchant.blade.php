                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('merchant_categories',__('Merchant Categories')) }}
                                        {!! Form::select('merchant_categories',$merchantCategories,null,['class'=>'form-control','id'=>'merchant_categories']) !!}
                                    </fieldset>
                                </div>
