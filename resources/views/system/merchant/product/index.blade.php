                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('merchantSelect2',__('Merchant')) }}
                                        <div>
                                ...
                                <div class="col-md-12" style="display: none;" id="merchant_product_category_id_div">
                                    <fieldset class="form-group">
                                        {{ Form::label('merchant_product_category_id',__('Product Category')) }}
                                        <div>
                                            {!! Form::select('merchant_product_category_id',[''=>__('Select Product Category')],null,['style'=>'width: 100%;' ,'id'=>'merchant_product_category_id','class'=>'form-control col-md-12']) !!}
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12" style="display: none;" id="created_by_merchant_staff_id_div">
                                    <fieldset class="form-group">
                                        {{ Form::label('created_by_merchant_staff_id',__('Created By Merchant Staff')) }}
                                        <div>
                                            {!! Form::select('created_by_merchant_staff_id',[''=>__('Select Merchant Staff')],null,['style'=>'width: 100%;' ,'id'=>'created_by_merchant_staff_id','class'=>'form-control col-md-12']) !!}
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('is_approved',__('Is Approved')) }}
                                        <div>
                                            {!! Form::select('is_approved',[''=>__('Select Approval Status'),'yes'=>__('Yes'),'no'=>__('No')],null,['id'=>'is_approved','class'=>'form-control']) !!}
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        {{ Form::label('staffSelect2',__('Approved By')) }}
                                        <div>
                                            {!! Form::select('approved_by_staff_id',[''=>__('Select Staff')],null,['style'=>'width: 100%;' ,'id'=>'staffSelect2','class'=>'form-control col-md-12']) !!}
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('approved_at1',__('Approved At From')) }}
                                        {!! Form::text('approved_at1',null,['class'=>'form-control datepicker','id'=>'approved_at1']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('approved_at2',__('Approved At To')) }}
                                        {!! Form::text('approved_at2',null,['class'=>'form-control datepicker','id'=>'approved_at2']) !!}
                                    </fieldset>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $('#merchantSelect2').change(function(){
            ...
            $.getJSON('{{route('system.ajax.get')}}',{
                ...
                $newData = new Array;
                $newData.push('<option value="">Select Merchant Staff</option>');
                $.each($data,function(key,value){
