                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('type',['product'=>__('E-Commerce Coupon'),'service'=>__('E-Payment Coupon')],null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('user_id',[''=>__('Select User')],null,['style'=>'width: 100%;' ,'id'=>'userSelect2','class'=>'form-control col-md-12']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('reward_start',__('Reward starts from')) }}
                                        {!! Form::number('reward_start',null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>

                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('reward_end',__('Reward ends at')) }}
                                        {!! Form::number('reward_end',null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('item',[''=>__('Select Item')],null,['style'=>'width: 100%;' ,'id'=>'itemSelect2','class'=>'form-control col-md-12']) !!}
                                    </fieldset>
                                </div>
                                -->
...
@section('footer')
    ...
    <script src="//maps.googleapis.com/maps/api/js?key={{env('gmap_key')}}&callback=initMap" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        ajaxSelect2('#userSelect2','customer');
