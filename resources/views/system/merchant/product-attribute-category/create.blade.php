                ...
                <section id="server-processing">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            @endif
                                @if(isset($result))
                                    {!! Form::model($result,['route' => ['merchant.product-attributes-category.update',$result->id],'method' => 'PATCH']) !!}
                                @else
                                    {!! Form::open(['route' => 'merchant.product-attributes-category.store', 'method' => 'POST']) !!}
                                @endif
                                <div class="col-sm-6">
                                    <div class="card">
                                        ...
                                        <div class="card-block card-dashboard">
                                            ...
                                            <div class="form-group col-sm-12{!! formError($errors,'name_en',true) !!}">
                                                <div class="controls">
                                                    {!! Form::label('name_en', __('Product attribute category name (English)').':') !!}
                                            ...
                                            <div class="form-group col-sm-12{!! formError($errors,'description_en',true) !!}">
                                                <div class="controls">
                                                    {!! Form::label('description_en', __('Product attribute category description (English)').':') !!}
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block card-dashboard">
                                            <div class="form-group col-sm-12{!! formError($errors,'name_ar',true) !!}">
                                                <div class="controls">
                                                    {!! Form::label('name_ar', __('Product attribute category Name (Arabic)').':') !!}
                                            ...
                                            <div class="form-group col-sm-12{!! formError($errors,'description_ar',true) !!}">
                                                <div class="controls">
                                                    {!! Form::label('description_ar', __('Product attribute category description (Arabic)').':') !!}
