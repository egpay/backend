                    ...
                    <div class="card-body">
                        <div class="card-block">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('months1',__('Months From')) }}
                                        {!! Form::number('months1',null,['class'=>'form-control','id'=>'months1']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('months2',__('Months To')) }}
                                        {!! Form::number('months2',null,['class'=>'form-control','id'=>'months2']) !!}
                                    </fieldset>
                                </div>
