                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::text('model_type',null,['class'=>'form-control','id'=>'model_type','placeholder'=>'App\Models\Users']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('appointment_date_time1',__('Appointment Date Time From')) }}
                                    {!! Form::text('appointment_date_time1',null,['class'=>'form-control datepicker','id'=>'appointment_date_time1']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('appointment_date_time2',__('Appointment Date Time To')) }}
                                    {!! Form::text('appointment_date_time2',null,['class'=>'form-control datepicker','id'=>'appointment_date_time2']) !!}
                                </fieldset>
                            </div>
