                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('walletowner_type',__('Owner Type')) }}
                                    {!! Form::select('walletowner_type',$walletOwnerTypeArray,null,['class'=>'form-control','id'=>'walletowner_type']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('walletowner_id',__('Owner ID')) }}
                                    {!! Form::number('walletowner_id',null,['class'=>'form-control','id'=>'walletowner_id']) !!}
                                </fieldset>
                            </div>
