                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::number('national_id',null,['class'=>'form-control','id'=>'national_id']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::number('mobile',null,['class'=>'form-control','id'=>'mobile']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('permission_group_id',[__('Select Permission Group')]+$PermissionGroup,null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
