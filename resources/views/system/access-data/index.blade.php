                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <div class="card-block card-dashboard">
                                        ...
                                        <div class="form-group col-sm-12{!! formError($errors,'user_type',true) !!}">
                                            <div class="controls">
                                                {!! Form::label('user_type', __('User Type').':') !!}
                                                {!! Form::select('user_type',['user'=>__('User'),'merchant'=>__('Merchant')],null,['class'=>'form-control']) !!}
                                            </div>
                                            {!! formError($errors,'user_type') !!}
                                        </div>
