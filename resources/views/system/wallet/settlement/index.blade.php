                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::select('status',[''=>__('Select Status'),'processing'=>__('Processing'),'error'=>__('Error'),'done'=>__('Done')],null,['class'=>'form-control','id'=>'status']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('system_commission1',__('System Commission From')) }}
                                    {!! Form::number('system_commission1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('system_commission2',__('System Commission To')) }}
                                    {!! Form::number('system_commission2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('agent_commission1',__('Agent Commission From')) }}
                                    {!! Form::number('agent_commission1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('agent_commission2',__('Agent Commission To')) }}
                                    {!! Form::number('agent_commission2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>

                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('merchant_commission1',__('Merchant Commission From')) }}
                                    {!! Form::number('merchant_commission1',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('merchant_commission2',__('Merchant Commission To')) }}
                                    {!! Form::number('merchant_commission2',null,['class'=>'form-control']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::number('wallet_id',null,['class'=>'form-control','id'=>'wallet_id']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    {!! Form::number('agent_id',null,['class'=>'form-control','id'=>'agent_id']) !!}
                                </fieldset>
                            </div>
