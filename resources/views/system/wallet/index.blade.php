                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('type',__('Wallet type')) }}
                                    {!! Form::select('type',[__('Wallet Type'),'payment'=>__('Payment'),'e-commerce'=>__('E-commerce'),'loyalty'=>__('Loyalty')],null,['class'=>'form-control','id'=>'type']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('balance1',__('Balance From')) }}
                                    {!! Form::number('balance1',null,['class'=>'form-control','id'=>'balance1']) !!}
                                </fieldset>
                            </div>
                            ...
                            <div class="col-md-6">
                                <fieldset class="form-group">
                                    {{ Form::label('balance2',__('Balance To')) }}
                                    {!! Form::number('balance2',null,['class'=>'form-control','id'=>'balance2']) !!}
                                </fieldset>
                            </div>
        ...
        $dataTableVar = $('#egpay-datatable').DataTable({
            ...
            "fnPreDrawCallback": function(oSettings) {
                for (var i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
                    ...
                    $('#SYSTEM_TOTAL').html('<b>'+oSettings.aoData[i]._aData[6]+'</b>');
