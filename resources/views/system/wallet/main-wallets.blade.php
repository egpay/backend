                                            ...
                                            <tbody>
                                                @foreach($result as $key => $value)
                                                    <tr>
                                                        <td>{{$value->id}}</td>
                                                        <td>
                                                            <a href="javascript:void(0);" onclick="urlIframe('{{route('system.wallet.index',['walletowner_type'=>'main_wallets','walletowner_id'=>$value->id])}}')">{{strtoupper($value->unique_name)}}</a>
                                                        </td>
                                                        <td>{{$value->name}}</td>
