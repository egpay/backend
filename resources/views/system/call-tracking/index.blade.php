                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::select('type',['in'=>__('Call-In'),'out'=>__('Call-Out')],null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        {!! Form::number('caller_name',null,['class'=>'form-control']) !!}
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('calltime_start',__('Reward starts from')) }}
                                        {!! Form::number('calltime_start',null,['class'=>'form-control datepicker','id'=>'calltime_start']) !!}
                                    </fieldset>
                                </div>

                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        {{ Form::label('calltime_end',__('Reward ends at')) }}
                                        {!! Form::number('calltime_end',null,['class'=>'form-control datepicker','id'=>'calltime_end']) !!}
                                    </fieldset>
                                </div>
