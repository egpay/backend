...
<head>
    ...
    @endphp
    <title>{{ucfirst(request()->route()->getActionMethod())}} {{str_replace('Controller','',$matches[1])}} - {{setting('sitename_'.$systemLang)}} {{__('System')}}</title>
        ...
        @else
            @if(request('without_navbar') == 'true')
                ...
                @else
                        ...
                        <div class="navbar-wrapper">
                            <div class="navbar-header">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="nav-item"><a href="{{route('system.dashboard')}}" class="navbar-brand"><h2 class="brand-text">EGPAY</h2></a></li>
                            ...
                            <div class="navbar-container content container-fluid">
                                <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                                    ...
                                    <ul class="nav navbar-nav float-xs-right">
                                        ...
                                        <li class="nav-item">
                                            <a href="javascript:void(0);" title="{{__('Send Email or SMS')}}" onclick="$('#sender-modal').modal('show');" class="nav-link">
                    ...
                    <div class="modal fade text-xs-left" id="sender-modal"  role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['id'=>'sender-form','method'=>'POST','route'=>'system.sender.store','onsubmit'=>'return false;']) !!}
                                <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        {{ Form::label('sender_type',__('Type')) }}
                                                        {!! Form::select('type',['email'=>__('Email'),'sms'=>__('SMS')],null,['id'=>'sender_type','class'=>'form-control']) !!}
                                                        <p class="text-xs-left"><small id="sender-type-error" class="danger text-muted"></small></p>
                                                    </fieldset>
                                                </div>

                                                <div class="col-md-12">
                                                    <fieldset class="form-group">
                                                        {{ Form::label('sender_send_to',__('Send To')) }}
                                                        {!! Form::text('send_to',null,['id'=>'sender_send_to','class'=>'form-control']) !!}
                                                        <p class="text-xs-left"><small id="sender-send_to-error" class="danger text-muted"></small></p>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div id="sender-email-div">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_from_name',__('From Name')) }}
                                                            {!! Form::text('from_name',Auth::id(),['id'=>'sender_from_name','class'=>'form-control']) !!}
                                                            <p class="text-xs-left"><small id="sender-from_name-error" class="danger text-muted"></small></p>
                                                        </fieldset>
                                                    </div>

                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_from_email',__('From Email')) }}
                                                            {!! Form::email('from_email',null,['id'=>'sender_from_email','class'=>'form-control']) !!}
                                                            <p class="text-xs-left"><small id="sender-from_email-error" class="danger text-muted"></small></p>
                                                        </fieldset>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_subject',__('Subject')) }}
                                                            {!! Form::text('subject',null,['id'=>'sender_subject','class'=>'form-control']) !!}
                                                            <p class="text-xs-left"><small id="sender-subject-error" class="danger text-muted"></small></p>
                                                        </fieldset>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_email_body',__('Body')) }}
                                                            {!! Form::textarea('email_body',null,['class'=>'form-control','id'=>'sender_email_body']) !!}
                                                            <p class="text-xs-left"><small id="sender-email_body-error" class="danger text-muted"></small></p>
                                                        </fieldset>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_file',__('Attachment')) }}
                                                            {!! Form::file('file',['class'=>'form-control','id'=>'sender_file']) !!}
                                                            <p class="text-xs-left"><small id="sender-file-error" class="danger text-muted"></small></p>
                                                ...
                                                <div style="display: none;" id="sender-sms-div">
                                                    <div class="col-md-12">
                                                        <fieldset class="form-group">
                                                            {{ Form::label('sender_sms_body',__('SMS')) }}
                                                            {!! Form::textarea('sms_body',null,['class'=>'form-control','id'=>'sender_sms_body']) !!}
                                                            <b id="sender-sms_body"></b> {{__('SMS')}} (<b id="sender-sms_length"></b>) {{__('Characters left')}}
                                                            <p class="text-xs-left"><small id="sender-sms_body-error" class="danger text-muted"></small></p>
                                                        </fieldset>
                                                    </div>
                                                </div>
                    ...
                    <footer class="footer footer-light navbar-border">
                        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; {{date('Y')}} <a href="https://www.egpay.com" target="_blank" class="text-bold-800 grey darken-2">EGPAY </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Build with <i style="color: red;" class="fa fa-heart text-city"></i> In Egypt</span></p>
                    </footer>
                    ...
                    <script src="{{asset('assets/system/node.js')}}" type="text/javascript"></script>
                    <!-- More Footer -->
                    @yield('footer')
                    <!-- More Footer -->
