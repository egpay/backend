...
//                setError(collect($serviceList)->toArray(),null,null);
            ...
            case '20010':
                ...
                return self::outPut(false, 'Service not available8', 20003);
            break;
        }
...
class Bee implements \App\Libs\Payments\PaymentInterface{
    ...
    private static function makeRequest($action, array $data, $locale = 'en'){
        ...
        try{
            $response = Requests::post($BeeUrl,['Content-Type' => 'text/xml'],$generateXMLRequest,['hooks'=> $hooks,'timeout'=>50,'connect_timeout'=>50]);
     ...
     * @return bool|\SimpleXMLElement
     */
    public static function serviceList($serviceVersion = 0,$locale = 'en'){
        return static::makeRequest('ServiceList',['serviceVersion'=>$serviceVersion],$locale);
    }
